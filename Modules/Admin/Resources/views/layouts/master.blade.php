...
Link Page: https://pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/
...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('backend/img/apple-touch-icon-152x152.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('backend/img/favicon-32x32.png') }}">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <!-- BEGIN: VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/vendors/vendors.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/vendors/animate-css/animate.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/vendors/chartist-js/chartist.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/vendors/chartist-js/chartist-plugin-tooltip.css') }}">
    <!-- END: VENDOR CSS-->
    <!-- BEGIN: Page Level CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/css/themes/materialize.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/css/themes/style.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/css/pages/dashboard-modern.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/css/pages/intro.min.css') }}">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
            <div class="nav-wrapper">
                ...
                <ul class="navbar-list right">
                    ...
                    <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="{{ asset('backend/img/logo-admin.png') }}" alt="avatar"><i></i></span></a></li>
...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
    <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href=""><img class="hide-on-med-and-down" src="{{ asset('backend/img/materialize-logo-color.png') }}" alt="materialize logo"/><img class="show-on-medium-and-down hide-on-med-and-up" src="../../../app-assets/images/logo/materialize-logo.png" alt="materialize logo"/><span class="logo-text hide-on-med-and-down">Materialize</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
    </div>
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li class="bold"><a class="waves-effect waves-cyan " href="changelog.html"><i class="material-icons">track_changes</i><span class="menu-title" data-i18n="Changelog">Changelog</span><span class="badge badge pill light-blue float-right mr-10">6.0</span></a>
        </li>
...
<script src="{{ asset('backend/vendors/chartist-js/chartist.min.js') }}"></script>
<script src="{{ asset('backend/vendors/chartist-js/chartist-plugin-tooltip.js') }}"></script>
<script src="{{ asset('backend/vendors/chartist-js/chartist-plugin-fill-donut.min.js') }}"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN THEME  JS-->
<script src="{{ asset('backend/js/plugins.min.js') }}"></script>
<script src="{{ asset('backend/js/search.min.js') }}"></script>
<script src="{{ asset('backend/js/custom/custom-script.min.js') }}"></script>
<script src="{{ asset('backend/js/scripts/customizer.min.js') }}"></script>
<!-- END THEME  JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{ asset('backend/js/scripts/dashboard-modern.js') }}"></script>
<script src="{{ asset('backend/js/scripts/intro.min.js') }}"></script>
<!-- END PAGE LEVEL JS-->
</body>
</html>
