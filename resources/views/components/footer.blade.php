                        ...
                        <div class="single-snap-footer">
                            ...
                            <div class="cakewalk-footer-content">
                                <ul>
                                    ...
                                    <li><a href="#">Chính sách riêng</a></li>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        <div class="info-fcontainer">
                            ...
                            <div class="infof-content">
                                ...
                                <p>Nguyễn Đình Hiến-Ngũ Hành Sơn-Đà Nẵng</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4">
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="info-fcontainer">
                            ...
                            <div class="infof-content">
                                <h3>Email hộ trợ</h3>
                                <p>maixuanthuong1610@gmail.com</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <address>Copyright © <a href="">MXT2K.</a> All Rights Reserved</address>
                    </div>
                    <div class="col-md-6 col-xs-12">
